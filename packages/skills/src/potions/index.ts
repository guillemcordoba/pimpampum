...
export const ALL_POTIONS: ActionDefinition[] = [
  action({
    ...
    unlock: 0, type: ActionType.Focus, speed: 3, dice: d(2, 4), consumable: true,
  ...
  action({
    ...
    unlock: 0, type: ActionType.Focus, speed: 3, consumable: true,
  ...
  action({
    ...
    unlock: 0, type: ActionType.Focus, speed: 1, consumable: true,
