...
export const PIROMANCIA: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'cadena-de-llamps', name: 'Cadena de llamps', skillId: 'piromancia', unlock: 20, type: ActionType.Atac, speed: -1, damage: d(1, 4, -1), targetCount: 2, fatigueCost: 2, desc: 'Afecta a 2 enemics que triïs.', icon: 'lorc/lightning-helix.svg' }),
  ],
};
...
export const CRIOMANCIA: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'pantalla-protectora', name: 'Pantalla protectora', skillId: 'criomancia', unlock: 10, type: ActionType.Defensa, speed: 2, rollBonus: 3, targetCount: 2, fatigueCost: 2, desc: 'Defensa a 2 jugadors que triïs.', icon: 'lorc/magic-shield.svg' }),
    ...
    action({ id: 'polimorfisme', name: 'Polimorfisme', skillId: 'criomancia', unlock: 40, type: ActionType.Focus, speed: -3, fatigueCost: 2, effects: [
...
export const MAGIA_ARCANA: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'curacio', name: 'Curació', skillId: 'magia-arcana', unlock: 10, type: ActionType.Focus, speed: 2, effects: [{ type: 'heal', params: { mode: 'roll', target: 'ally' } }], desc: 'Tria un aliat. Tira d20 + habilitat - fatiga. Cura el total ÷ 4.', icon: 'delapouite/healing.svg' }),
    ...
    action({ id: 'invocacio-espiritual', name: 'Invocació espiritual', skillId: 'magia-arcana', unlock: 40, type: ActionType.Focus, speed: -4, fatigueCost: 2, effects: [
    ...
    action({ id: 'maledicccio-mortal', name: 'Maledicció mortal', skillId: 'magia-arcana', unlock: 50, type: ActionType.Focus, speed: -3, fatigueCost: 2, effects: [
...
export const MAGIA_DE_SANG: SkillDefinition = {
  ...
  actions: [
    action({ id: 'explosio', name: 'Explosió', skillId: 'magia-de-sang', unlock: 1, type: ActionType.Atac, speed: -2, damage: d(1, 8), targetCount: 99, fatigueCost: 2, effects: [{ type: 'self_damage', params: { amount: 1 } }], desc: 'Atac a tots els personatges (aliats inclosos). Després, et fas 1 ferida a tu mateix.', icon: 'lorc/explosion-rays.svg' }),
    ...
    action({ id: 'magia-de-sang-ritual', name: 'Màgia de sang', skillId: 'magia-de-sang', unlock: 25, type: ActionType.Focus, speed: -3, fatigueCost: 2, effects: [
...
export const MAGIA_ARCANA_INNATA: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'marca-bessona', name: 'Marca bessona', skillId: 'magia-arcana-innata', unlock: 15, type: ActionType.Atac, speed: 0, damage: d(1, 4), targetCount: 2, fatigueCost: 2, effects: [{ type: 'mark_on_hit', params: { amount: 1 } }], desc: 'Ataca 2 enemics. Els marca amb una marca arcana.', icon: 'lorc/double-face-mask.svg' }),
    ...
    action({ id: 'detonacio-arcana', name: 'Detonació arcana', skillId: 'magia-arcana-innata', unlock: 35, type: ActionType.Focus, speed: -3, fatigueCost: 2, effects: [{ type: 'detonate', params: { perMark: 1 } }], desc: 'Detona totes les marques arcanes. Cada marca causa 1 ferida.', icon: 'sbed/blast.svg' }),
  ],
};
...
export const MANIPULACIO_TEMPORAL: SkillDefinition = {
  ...
  actions: [
    action({ id: 'distorsio-temporal', name: 'Distorsió temporal', skillId: 'manipulacio-temporal', unlock: 1, type: ActionType.Focus, speed: -4, fatigueCost: 2, effects: [{ type: 'skill_mod', params: { kind: 'speed', amount: -2, target: 'enemies', duration: 3 } }], desc: 'Tots els enemics reben {V}-2 durant 3 torns.', icon: 'lorc/time-trap.svg' }),
  ],
};
