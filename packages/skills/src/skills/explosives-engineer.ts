...
export const ENGINYER_EXPLOSIUS: SkillDefinition = {
  ...
  actions: [
    action({
      ...
      desc: 'Llença una granada a la línia enemiga; la metralla afecta tots els enemics. Gasta 1 càrrega.',
    ...
    action({
      ...
      desc: 'Desplega una cortina de fum. Cada enemic que ataca aquest torn tira un d20: amb 10 o menys, l’atac impacta un personatge a l’atzar.',
    ...
    action({
      ...
      desc: 'Una càrrega conformada que perfora qualsevol cuirassa. Ignora completament l’armadura. Gasta 1 càrrega.',
    ...
    action({
      ...
      desc: 'Sembra el terreny amb 3 mines (gasta 3 càrregues). Cada enemic que ataca té un 50% (d20 ≤ 10) de trepitjar-ne una i rebre 1d6, ignorant l’armadura. Duren fins que s’esgoten.',
    ...
    action({
      ...
      desc: 'Encén tot el bandoler en una cadena d’explosions: cada enemic rep Nd6, on N és el nombre de càrregues que et queden. Buida el bandoler.',
