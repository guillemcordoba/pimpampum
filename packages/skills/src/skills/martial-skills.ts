...
export const EARTHBENDER: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'empenta-de-terra', name: 'Empenta de terra', skillId: 'earthbender', unlock: 5, type: ActionType.Atac, speed: 1, damage: d(1, 4), effects: [{ type: 'debuff_on_hit', params: { kind: 'speed', amount: 3, duration: 'nextTurn' } }], desc: "Una onada de terra empeny l'enemic. Si fa mal, rep {V}-3 el pròxim torn.", icon: 'delapouite/boulder-dash.svg' }),
    ...
    action({ id: 'punxes-de-roca', name: 'Punxes de roca', skillId: 'earthbender', unlock: 20, type: ActionType.Atac, speed: -1, damage: d(1, 4), targetCount: 2, fatigueCost: 2, desc: 'Fas brollar punxes de pedra del terra sota 2 enemics que triïs.', icon: 'lorc/crags.svg' }),
    action({ id: 'pilar-de-roca', name: 'Pilar de roca', skillId: 'earthbender', unlock: 25, type: ActionType.Atac, speed: -1, damage: d(1, 4), fatigueCost: 2, effects: [{ type: 'stun_on_hit', params: { turns: 1 } }], desc: "Un pilar de pedra brolla i atrapa l'enemic. Si fa mal, queda atordit el pròxim torn.", icon: 'lorc/stone-tower.svg' }),
    ...
    ], desc: 'Tria un enemic. El terra se li enfonsa: {V}-3 i {D}-2 durant els pròxims 2 torns.', icon: 'lorc/swallow.svg' }),
    ...
    action({ id: 'control-del-metall', name: 'Control del metall', skillId: 'earthbender', unlock: 45, type: ActionType.Atac, speed: -1, damage: d(1, 6), effects: [{ type: 'piercing', params: {} }], desc: "Doblegues les impureses del metall. Ignora les cartes de Defensa — sempre colpeja l'objectiu original.", icon: 'delapouite/metal-golem-head.svg' }),
