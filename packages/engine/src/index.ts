...
export {
  createFighter, createWizard, createRogue, createBarbarian, createCleric, createMonk, createBard, createSorcerer, createPaladin,
  ...
  CLERIC_TEMPLATE, MONK_TEMPLATE, BARD_TEMPLATE, SORCERER_TEMPLATE, PALADIN_TEMPLATE, GOBLIN_TEMPLATE, GOBLIN_SHAMAN_TEMPLATE, BASILISK_TEMPLATE,
