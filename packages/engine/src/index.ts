...
export {
  createFighter, createWizard, createRogue, createBarbarian, createCleric, createMonk, createBard, createSorcerer, createPaladin, createDruid,
  ...
  CLERIC_TEMPLATE, MONK_TEMPLATE, BARD_TEMPLATE, SORCERER_TEMPLATE, PALADIN_TEMPLATE, DRUID_TEMPLATE, GOBLIN_TEMPLATE, GOBLIN_SHAMAN_TEMPLATE, BASILISK_TEMPLATE,
