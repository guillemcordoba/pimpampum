...
export {
  createFighter, createWizard, createRogue, createBarbarian, createCleric,
  createGoblin, createGoblinShaman,
  ...
  CLERIC_TEMPLATE, GOBLIN_TEMPLATE, GOBLIN_SHAMAN_TEMPLATE,
