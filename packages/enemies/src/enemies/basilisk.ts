...
const BASILISK_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'cop-de-cua', name: 'Cop de cua', skillId: 'basilisk', unlock: 2, type: ActionType.Atac, speed: 2, dice: d(2, 6), targetCount: 3, fatigueCost: 2, desc: 'Colpeja fins a 3 enemics amb la cua.', icon: 'lorc/spiked-tail.svg' }),
...
export const BASILISK: EnemyModule = {
  template: { id: 'basilisk', displayName: 'Basilisc', classCss: 'basilisc', iconPath: ICON + 'delapouite/spiked-dragon-head.svg', role: 'solitari', threat: 0.504, skills: ['basilisk'], basePV: 43, suggestedLevel: 5, naturalArmor: 2, aiStrategy: AIStrategy.Power },
