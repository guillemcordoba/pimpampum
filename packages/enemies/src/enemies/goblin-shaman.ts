...
const GOBLIN_SHAMAN_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'possessio-demoniaca', name: 'Possessió demoníaca', skillId: 'goblin-shaman', unlock: 4, type: ActionType.Focus, speed: -3, fatigueCost: 2, effects: [
    ...
    action({ id: 'set-de-sang', name: 'Set de sang', skillId: 'goblin-shaman', unlock: 2, type: ActionType.Focus, speed: -4, effects: [{ type: 'wound_wounded', params: { damage: 3 } }], desc: 'Cada enemic que hagi perdut PV durant aquest combat perd 3 PV, ignorant defenses i armadura.', icon: 'skoll/blood.svg' }),
...
export const GOBLIN_SHAMAN: EnemyModule = {
  template: { id: 'goblin-shaman', displayName: 'Goblin Xaman', classCss: 'goblin-shaman', iconPath: ICON + 'delapouite/skull-staff.svg', role: 'elit', threat: 0.072, skills: ['goblin-shaman'], basePV: 9, suggestedLevel: 4, aiStrategy: AIStrategy.Power },
