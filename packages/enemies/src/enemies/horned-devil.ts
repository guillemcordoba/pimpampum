...
const HORNED_DEVIL_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'defensa-diabolica', name: 'Defensa diabòlica', skillId: 'horned-devil', unlock: 3, type: ActionType.Defensa, speed: 1, dice: d(2, 8), effects: [{ type: 'debuff_on_block', params: { kind: 'attack', amount: 3, duration: 'nextTurn' } }], desc: "Si bloqueges un atac, l'atacant té {A}−3 el proper torn.", icon: 'lorc/spiked-armor.svg' }),
    ...
    action({ id: 'flames-de-l-avern', name: "Flames de l'avern", skillId: 'horned-devil', unlock: 5, type: ActionType.Focus, speed: -5, fatigueCost: 4, effects: [
