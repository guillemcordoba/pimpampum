...
const COMBAT_DIABOLIC: SkillDefinition = {
  ...
  iconPath: ICON + 'lorc/trident.svg',
  actions: [
...
const FOC_AVERN: SkillDefinition = {
  ...
  iconPath: ICON + 'lorc/fire-breath.svg',
  actions: [
...
export const HORNED_DEVIL: EnemyModule = {
  template: { id: 'horned-devil', displayName: 'Diable Banyut', classCss: 'diable-banyut', iconPath: ICON + 'delapouite/devil-mask.svg', basePV: 18, skills: ['combat-diabolic', 'foc-avern'], suggestedLevel: 40 },
  skills: [COMBAT_DIABOLIC, FOC_AVERN],
};
