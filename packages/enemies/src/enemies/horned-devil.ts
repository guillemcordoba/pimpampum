...
export const HORNED_DEVIL: EnemyModule = {
  template: { id: 'horned-devil', displayName: 'Diable Banyut', classCss: 'diable-banyut', iconPath: ICON + 'delapouite/devil-mask.svg', role: 'solitari', threat: 0.238, skills: ['horned-devil'], basePV: 34, suggestedLevel: 6 },
