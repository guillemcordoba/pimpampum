...
const SPINED_DEVIL_SKILL: SkillDefinition = {
  ...
  actions: [
    action({ id: 'mossegada-en-vol', name: 'Mossegada en vol', skillId: 'spined-devil', unlock: 1, type: ActionType.Atac, speed: 4, dice: d(2, 6, -1), rollBonus: 2, desc: '', icon: 'lorc/bat-wing.svg' }),
    action({ id: 'cortina-de-foc', name: 'Cortina de foc', skillId: 'spined-devil', unlock: 3, type: ActionType.Defensa, speed: 2, dice: d(2, 6), rollBonus: 2, desc: '', icon: 'lorc/fire-shield.svg' }),
...
export const SPINED_DEVIL: EnemyModule = {
  template: { id: 'spined-devil', displayName: 'Diable Espinós', classCss: 'diable-espinos', iconPath: ICON + 'lorc/imp.svg', role: 'elit', threat: 0.116, skills: ['spined-devil'], basePV: 7, suggestedLevel: 3 },
