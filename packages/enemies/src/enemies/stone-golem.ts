...
const STONE_GOLEM_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'destrossa', name: 'Destrossa', skillId: 'stone-golem', unlock: 4, type: ActionType.Atac, speed: -3, dice: d(2, 8), fatigueCost: 2, effects: [{ type: 'double_wound', params: { amount: 3 } }], desc: "Si fa ferida, l'enemic perd 3 PV addicionals.", icon: 'lorc/thor-fist.svg' }),
    ...
    action({ id: 'enduriment', name: 'Enduriment', skillId: 'stone-golem', unlock: 5, type: ActionType.Focus, speed: -2, fatigueCost: 2, effects: [
...
export const STONE_GOLEM: EnemyModule = {
  template: { id: 'stone-golem', displayName: 'Gòlem de Pedra', classCss: 'golem-de-pedra', iconPath: ICON + 'delapouite/rock-golem.svg', role: 'elit', threat: 0.232, skills: ['stone-golem'], basePV: 17, suggestedLevel: 5, aiStrategy: AIStrategy.Protect },
