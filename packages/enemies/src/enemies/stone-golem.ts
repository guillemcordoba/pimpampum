...
const FORCA_PEDRA: SkillDefinition = {
...
export const STONE_GOLEM: EnemyModule = {
  template: { id: 'stone-golem', displayName: 'Gòlem de Pedra', classCss: 'golem-de-pedra', iconPath: ICON + 'delapouite/rock-golem.svg', basePV: 14, skills: ['forca-pedra'], suggestedLevel: 35 },
  skills: [FORCA_PEDRA],
};
