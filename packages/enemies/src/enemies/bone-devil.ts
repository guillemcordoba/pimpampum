...
const BONE_DEVIL_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'esgarrapada', name: 'Esgarrapada', skillId: 'bone-devil', unlock: 1, type: ActionType.Atac, speed: 3, damage: d(1, 4), desc: 'Una esgarrapada ràpida.', icon: 'lorc/claw-slashes.svg' }),
    ...
    action({ id: 'marca-de-la-mort', name: 'Marca de la mort', skillId: 'bone-devil', unlock: 1, type: ActionType.Focus, speed: -1, fatigueCost: 2, effects: [{ type: 'doom_mark', params: { amount: 1, turns: -1 } }], desc: 'Marca un enemic. La pròxima ferida que rebi li costa una vida addicional.', icon: 'lorc/death-zone.svg' }),
  ],
};

export const BONE_DEVIL: EnemyModule = {
  template: { id: 'bone-devil', displayName: "Diable d'Os", classCss: 'diable-dos', iconPath: ICON + 'lorc/daemon-skull.svg', role: 'elit', difficulty: 0.97, skills: ['bone-devil'], suggestedLevel: 30, aiStrategy: AIStrategy.Power },
