...
export const BONE_DEVIL: EnemyModule = {
  template: { id: 'bone-devil', displayName: "Diable d'Os", classCss: 'diable-dos', iconPath: ICON + 'lorc/daemon-skull.svg', role: 'elit', difficulty: 0.48, skills: ['bone-devil'], suggestedLevel: 30, aiStrategy: AIStrategy.Power },
