...
const BONE_DEVIL_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'esgarrapada', name: 'Esgarrapada', skillId: 'bone-devil', unlock: 1, type: ActionType.Atac, speed: 3, dice: d(1, 2), desc: '', icon: 'lorc/claw-slashes.svg' }),
...
export const BONE_DEVIL: EnemyModule = {
  template: { id: 'bone-devil', displayName: "Diable d'Os", classCss: 'diable-dos', iconPath: ICON + 'lorc/daemon-skull.svg', role: 'elit', threat: 0.089, skills: ['bone-devil'], basePV: 13, suggestedLevel: 4, aiStrategy: AIStrategy.Power },
