...
const BONE_DEVIL_SKILL: SkillDefinition = {
  ...
  actions: [
    action({ id: 'defensa-esqueletica', name: 'Defensa esquelètica', skillId: 'bone-devil', unlock: 1, type: ActionType.Defensa, speed: 1, dice: d(3, 4), effects: [{ type: 'heal_on_block', params: { amount: 2 } }], desc: 'Si bloqueges un atac, recuperes 2 PV.', icon: 'lorc/ribcage.svg' }),
