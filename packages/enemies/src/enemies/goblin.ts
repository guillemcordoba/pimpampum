...
const GOBLIN_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'amagar-se', name: 'Amagar-se', skillId: 'goblin', unlock: 3, type: ActionType.Focus, speed: 2, effects: [{ type: 'nimble_escape', params: { amount: 5 } }], desc: 'Esquives tots els atacs aquest torn. El següent torn, {A}+5.', icon: 'lorc/hidden.svg' }),
