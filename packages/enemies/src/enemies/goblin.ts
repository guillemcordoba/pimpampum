...
export const GOBLIN: EnemyModule = {
  template: { id: 'goblin', displayName: 'Goblin', classCss: 'goblin', iconPath: ICON + 'delapouite/goblin-head.svg', role: 'horda', difficulty: 0.69, skills: ['goblin'], suggestedLevel: 20 },
  skills: [GOBLIN_SKILL],
};
