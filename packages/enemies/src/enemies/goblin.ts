...
const GOBLIN_SKILL: SkillDefinition = {
  ...
  actions: [
    ...
    action({ id: 'punyalada-rapida', name: 'Punyalada ràpida', skillId: 'goblin', unlock: 1, type: ActionType.Atac, speed: 3, damage: d(1, 4, -2), desc: 'Una ganivetada ràpida.', icon: 'lorc/plain-dagger.svg' }),
    ...
    action({ id: 'amagar-se', name: 'Amagar-se', skillId: 'goblin', unlock: 1, type: ActionType.Focus, speed: 2, effects: [{ type: 'nimble_escape', params: { amount: 1 } }], desc: "Esquives tots els atacs aquest torn. El següent torn, {A}+1 per cada goblin que s'hagi amagat.", icon: 'lorc/hidden.svg' }),
  ],
};

export const GOBLIN: EnemyModule = {
  template: { id: 'goblin', displayName: 'Goblin', classCss: 'goblin', iconPath: ICON + 'delapouite/goblin-head.svg', role: 'horda', difficulty: 1.0, skills: ['goblin'], suggestedLevel: 20 },
  skills: [GOBLIN_SKILL],
};
