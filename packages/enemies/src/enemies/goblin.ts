...
const GOBLIN_SKILL: SkillDefinition = {
  ...
  actions: [
    action({ id: 'atac-horda', name: 'Atac de la horda', skillId: 'goblin', unlock: 3, type: ActionType.Atac, speed: 0, dice: d(1, 4), effects: [{ type: 'crossfire', params: { max: 5 } }], desc: '{A}+1 per cada altre aliat viu (màx. +5).', icon: 'delapouite/goblin-head.svg' }),
    ...
    action({ id: 'protegir-clan', name: 'Protegir el clan', skillId: 'goblin', unlock: 2, type: ActionType.Defensa, speed: 2, dice: d(2, 6), rollBonus: 2, desc: '', icon: 'willdabeast/round-shield.svg' }),
...
export const GOBLIN: EnemyModule = {
  template: { id: 'goblin', displayName: 'Goblin', classCss: 'goblin', iconPath: ICON + 'delapouite/goblin-head.svg', role: 'horda', threat: 0.050, skills: ['goblin'], basePV: 6, suggestedLevel: 4 },
  skills: [GOBLIN_SKILL],
};
